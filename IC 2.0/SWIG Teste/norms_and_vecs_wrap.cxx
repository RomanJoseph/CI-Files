...
#define SWIGTYPE_p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t swig_types[9]
...
#define SWIGTYPE_p_std__lessT_double_t swig_types[13]
#define SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t swig_types[14]
...
/*-----------------------------------------------
              @(target):= _norms_and_vecs.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__norms_and_vecs

#else
#  define SWIG_init    init_norms_and_vecs

#endif
#define SWIG_name    "_norms_and_vecs"
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_double_Sg__Sg__insert__SWIG_1(std::vector< std::vector< double > > *self,std::vector< std::vector< double > >::iterator pos,std::vector< std::vector< double > >::size_type n,std::vector< std::vector< double > >::value_type const &x){ self->insert(pos, n, x); }
  ...
  namespace swig {
	...
	return obj;
      ...
      namespace swig {
	template <>  struct traits<std::pair< double, std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::pair<" "double" "," "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >" " >";
	  }
	};
      }
  ...
  namespace swig {
	...
	if (desc && desc->clientdata) {
      ...
      namespace swig {
	template <>  struct traits<std::map< double, std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >, std::less< double >, std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::map<" "double" "," "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >" "," "std::less< double >" "," "std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > >" " >";
	  }
	};
      }
    
SWIGINTERN swig::SwigPyIterator *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__iterator(std::map< double,std::vector< std::vector< double > > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____nonzero__(std::map< double,std::vector< std::vector< double > > > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____bool__(std::map< double,std::vector< std::vector< double > > > const *self){
      return !(self->empty());
    }
SWIGINTERN std::map< double,std::vector< std::vector< double > > >::size_type std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____len__(std::map< double,std::vector< std::vector< double > > > const *self){
      return self->size();
    }
SWIGINTERN std::map< double,std::vector< std::vector< double > > >::mapped_type const &std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____getitem__(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::const_iterator i = self->find(key);
      if (i != self->end())
	return i->second;
      else
	throw std::out_of_range("key not found");
    }
SWIGINTERN void std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____delitem__(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::iterator i = self->find(key);
      if (i != self->end())
	self->erase(i);
      else
	throw std::out_of_range("key not found");
    }
SWIGINTERN bool std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__has_key(std::map< double,std::vector< std::vector< double > > > const *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::const_iterator i = self->find(key);
      return i != self->end();
    }
SWIGINTERN PyObject *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__keys(std::map< double,std::vector< std::vector< double > > > *self){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
	PyErr_SetString(PyExc_OverflowError, "map size not valid in python");
	SWIG_PYTHON_THREAD_END_BLOCK;
	return NULL;
      ...
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::const_iterator i = self->begin();
...
SWIGINTERN PyObject *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__values(std::map< double,std::vector< std::vector< double > > > *self){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
...
SWIGINTERN PyObject *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__items(std::map< double,std::vector< std::vector< double > > > *self){
      std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
...
SWIGINTERN bool std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____contains__(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key){
      return self->find(key) != self->end();
    }
SWIGINTERN swig::SwigPyIterator *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__key_iterator(std::map< double,std::vector< std::vector< double > > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_key_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN swig::SwigPyIterator *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__value_iterator(std::map< double,std::vector< std::vector< double > > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_value_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN void std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____setitem____SWIG_0(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key){
      self->erase(key);
    }
SWIGINTERN void std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____setitem____SWIG_1(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::key_type const &key,std::map< double,std::vector< std::vector< double > > >::mapped_type const &x){
      (*self)[key] = x;
    }
SWIGINTERN PyObject *std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__asdict(std::map< double,std::vector< std::vector< double > > > *self){
      return swig::traits_from< std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > >::asdict(*self);
    }
SWIGINTERN void std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__erase__SWIG_1(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::iterator position){ self->erase(position); }
SWIGINTERN void std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__erase__SWIG_2(std::map< double,std::vector< std::vector< double > > > *self,std::map< double,std::vector< std::vector< double > > >::iterator first,std::map< double,std::vector< std::vector< double > > >::iterator last){ self->erase(first, last); }
...
SWIGINTERN PyObject *_wrap_new_DoubleMap__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::less< double > *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< double,std::vector< std::vector< double > > > *result = 0 ;
  
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_std__lessT_double_t,  0  | 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_DoubleMap" "', argument " "1"" of type '" "std::less< double > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_DoubleMap" "', argument " "1"" of type '" "std::less< double > const &""'"); 
  }
  arg1 = reinterpret_cast< std::less< double > * >(argp1);
  result = (std::map< double,std::vector< std::vector< double > > > *)new std::map< double,std::vector< std::vector< double > > >((std::less< double > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_DoubleMap_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_iterator" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___nonzero__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (bool)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____nonzero__((std::map< double,std::vector< std::vector< double > > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___bool__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___bool__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (bool)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____bool__((std::map< double,std::vector< std::vector< double > > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::map< double,std::vector< std::vector< double > > >::size_type result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___len__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____len__((std::map< double,std::vector< std::vector< double > > > const *)arg1);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type temp2 ;
  double val2 ;
  int ecode2 = 0 ;
  PyObject *swig_obj[2] ;
  std::map< double,std::vector< std::vector< double > > >::mapped_type *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap___getitem__", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___getitem__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap___getitem__" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  try {
    result = (std::map< double,std::vector< std::vector< double > > >::mapped_type *) &std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____getitem__(arg1,(double const &)*arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_DoubleMap___delitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap___delitem__", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___delitem__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap___delitem__" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  try {
    std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____delitem__(arg1,(double const &)*arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_DoubleMap_has_key(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_has_key", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_has_key" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_has_key" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (bool)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__has_key((std::map< double,std::vector< std::vector< double > > > const *)arg1,(double const &)*arg2);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_keys(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_keys" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (PyObject *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__keys(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_values(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_values" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (PyObject *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__values(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_items(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_items" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (PyObject *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__items(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___contains__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap___contains__", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___contains__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap___contains__" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (bool)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____contains__(arg1,(double const &)*arg2);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_key_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_key_iterator" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__key_iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_value_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_value_iterator" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__value_iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap___setitem__" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap___setitem__" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____setitem____SWIG_0(arg1,(double const &)*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  std::map< double,std::vector< std::vector< double > > >::mapped_type *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type temp2 ;
  double val2 ;
  ...
  arg2 = &temp2;
  {
    ...
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "DoubleMap___setitem__" "', argument " "3"" of type '" "std::map< double,std::vector< std::vector< double > > >::mapped_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "DoubleMap___setitem__" "', argument " "3"" of type '" "std::map< double,std::vector< std::vector< double > > >::mapped_type const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg____setitem____SWIG_1(arg1,(double const &)*arg2,(std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_DoubleMap___setitem__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "DoubleMap___setitem__", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_double(argv[1], NULL);
      ...
      if (_v) {
        return _wrap_DoubleMap___setitem____SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_DoubleMap___setitem____SWIG_1(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'DoubleMap___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::map< double,std::vector< std::vector< double > > >::__setitem__(std::map< double,std::vector< std::vector< double > > >::key_type const &)\n"
    "    std::map< double,std::vector< std::vector< double > > >::__setitem__(std::map< double,std::vector< std::vector< double > > >::key_type const &,std::map< double,std::vector< std::vector< double > > >::mapped_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_DoubleMap_asdict(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_asdict" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (PyObject *)std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__asdict(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_DoubleMap__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *result = 0 ;
  
  if ((nobjs < 0) || (nobjs > 0)) SWIG_fail;
  result = (std::map< double,std::vector< std::vector< double > > > *)new std::map< double,std::vector< std::vector< double > > >();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_DoubleMap__SWIG_2(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  std::map< double,std::vector< std::vector< double > > > *result = 0 ;
  
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > *ptr = (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > *)0;
    res1 = swig::asptr(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_DoubleMap" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_DoubleMap" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (std::map< double,std::vector< std::vector< double > > > *)new std::map< double,std::vector< std::vector< double > > >((std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_new_DoubleMap(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[2] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "new_DoubleMap", 0, 1, argv))) SWIG_fail;
  --argc;
  if (argc == 0) {
    return _wrap_new_DoubleMap__SWIG_1(self, argc, argv);
  }
  if (argc == 1) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_std__lessT_double_t, SWIG_POINTER_NO_NULL | 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_DoubleMap__SWIG_0(self, argc, argv);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_DoubleMap__SWIG_2(self, argc, argv);
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_DoubleMap'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::map< double,std::vector< std::vector< double > > >::map(std::less< double > const &)\n"
    "    std::map< double,std::vector< std::vector< double > > >::map()\n"
    "    std::map< double,std::vector< std::vector< double > > >::map(std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_DoubleMap_empty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_empty" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (bool)((std::map< double,std::vector< std::vector< double > > > const *)arg1)->empty();
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_size" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = ((std::map< double,std::vector< std::vector< double > > > const *)arg1)->size();
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_swap", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_swap" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "DoubleMap_swap" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "DoubleMap_swap" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > &""'"); 
  }
  arg2 = reinterpret_cast< std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > * >(argp2);
  (arg1)->swap(*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_DoubleMap_begin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::map< double,std::vector< std::vector< double > > >::iterator result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_begin" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (arg1)->begin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_end(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_end" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (arg1)->end();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_DoubleMap_rbegin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::map< double,std::vector< std::vector< double > > >::reverse_iterator result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_rbegin" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (arg1)->rbegin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::reverse_iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_rend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_rend" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = (arg1)->rend();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::reverse_iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_DoubleMap_clear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_clear" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  (arg1)->clear();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_DoubleMap_get_allocator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  SwigValueWrapper< std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_get_allocator" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  result = ((std::map< double,std::vector< std::vector< double > > > const *)arg1)->get_allocator();
  resultobj = SWIG_NewPointerObj((new std::map< double,std::vector< std::vector< double > > >::allocator_type(static_cast< const std::map< double,std::vector< std::vector< double > > >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_DoubleMap_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_erase" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_erase" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (arg1)->erase((std::map< double,std::vector< std::vector< double > > >::key_type const &)*arg2);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_count(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_count", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_count" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_count" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = ((std::map< double,std::vector< std::vector< double > > > const *)arg1)->count((std::map< double,std::vector< std::vector< double > > >::key_type const &)*arg2);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "DoubleMap_erase" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "DoubleMap_erase" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::iterator""'");
  ...
  std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__erase__SWIG_1(arg1,arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_erase__SWIG_2(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::iterator arg2 ;
  std::map< double,std::vector< std::vector< double > > >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  res3 = SWIG_ConvertPtr(swig_obj[2], SWIG_as_voidptrptr(&iter3), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "DoubleMap_erase" "', argument " "3"" of type '" "std::map< double,std::vector< std::vector< double > > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "DoubleMap_erase" "', argument " "3"" of type '" "std::map< double,std::vector< std::vector< double > > >::iterator""'");
  ...
  std_map_Sl_double_Sc_std_vector_Sl_std_vector_Sl_double_Sg__Sg__Sg__erase__SWIG_2(arg1,arg2,arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_DoubleMap_erase(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "DoubleMap_erase", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >**)(0));
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_DoubleMap_erase__SWIG_1(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_DoubleMap_erase__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::map< double,std::vector< std::vector< double > > >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_DoubleMap_erase__SWIG_2(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'DoubleMap_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::map< double,std::vector< std::vector< double > > >::erase(std::map< double,std::vector< std::vector< double > > >::key_type const &)\n"
    "    std::map< double,std::vector< std::vector< double > > >::erase(std::map< double,std::vector< std::vector< double > > >::iterator)\n"
    "    std::map< double,std::vector< std::vector< double > > >::erase(std::map< double,std::vector< std::vector< double > > >::iterator,std::map< double,std::vector< std::vector< double > > >::iterator)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_DoubleMap_find(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_find", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_find" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_find" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (arg1)->find((std::map< double,std::vector< std::vector< double > > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_DoubleMap_lower_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_lower_bound", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_lower_bound" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_lower_bound" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (arg1)->lower_bound((std::map< double,std::vector< std::vector< double > > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_DoubleMap_upper_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  std::map< double,std::vector< std::vector< double > > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "DoubleMap_upper_bound", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DoubleMap_upper_bound" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DoubleMap_upper_bound" "', argument " "2"" of type '" "std::map< double,std::vector< std::vector< double > > >::key_type""'");
  } 
  temp2 = static_cast< std::map< double,std::vector< std::vector< double > > >::key_type >(val2);
  arg2 = &temp2;
  result = (arg1)->upper_bound((std::map< double,std::vector< std::vector< double > > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< double,std::vector< std::vector< double > > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_delete_DoubleMap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< double,std::vector< std::vector< double > > > *arg1 = (std::map< double,std::vector< std::vector< double > > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_DoubleMap" "', argument " "1"" of type '" "std::map< double,std::vector< std::vector< double > > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< double,std::vector< std::vector< double > > > * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *DoubleMap_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *DoubleMap_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
SWIGINTERN PyObject *_wrap_IntVectorVector___getslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector___getslice__", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::difference_type arg2 ;
  std::vector< std::vector< int > >::difference_type arg3 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setslice____SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::difference_type arg2 ;
  std::vector< std::vector< int > >::difference_type arg3 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setslice__(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector___setslice__", 0, 4, argv))) SWIG_fail;
  --argc;
  if (argc == 3) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_IntVectorVector___setslice____SWIG_0(self, argc, argv);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_IntVectorVector___setslice____SWIG_1(self, argc, argv);
          }
        }
      }
    }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector___setslice__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector___delslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector___delslice__", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_IntVectorVector___delitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::difference_type arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___getitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___delitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___delitem__(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector___delitem__", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector___delitem____SWIG_1(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector___delitem____SWIG_0(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector___delitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector___getitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::difference_type arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___getitem__(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector___getitem__", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector___getitem____SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector___getitem____SWIG_1(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setitem____SWIG_2(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::difference_type arg2 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector___setitem__(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector___setitem__", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector___setitem____SWIG_1(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_IntVectorVector___setitem____SWIG_0(self, argc, argv);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_IntVectorVector___setitem____SWIG_2(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector_append(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector_append", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_IntVectorVector__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_new_IntVectorVector__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector_swap", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_IntVectorVector__SWIG_2(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_resize__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::iterator arg2 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_erase(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector_erase", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector_erase__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< int > >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_IntVectorVector_erase__SWIG_1(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_new_IntVectorVector__SWIG_3(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > >::size_type arg1 ;
  std::vector< std::vector< int > >::value_type *arg2 = 0 ;
  size_t val1 ;
...
SWIGINTERN PyObject *_wrap_new_IntVectorVector(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "new_IntVectorVector", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 0) {
    return _wrap_new_IntVectorVector__SWIG_0(self, argc, argv);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_IntVectorVector__SWIG_2(self, argc, argv);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_IntVectorVector__SWIG_1(self, argc, argv);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_IntVectorVector__SWIG_3(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_IntVectorVector'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector_push_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector_push_back", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_IntVectorVector_assign(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector_assign", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_IntVectorVector_resize__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::size_type arg2 ;
  std::vector< std::vector< int > >::value_type *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_resize(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector_resize", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntVectorVector_resize__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_IntVectorVector_resize__SWIG_1(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector_resize'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::iterator arg2 ;
  std::vector< std::vector< int > >::value_type *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< int > > *arg1 = (std::vector< std::vector< int > > *) 0 ;
  std::vector< std::vector< int > >::iterator arg2 ;
...
SWIGINTERN PyObject *_wrap_IntVectorVector_insert(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "IntVectorVector_insert", 0, 4, argv))) SWIG_fail;
  --argc;
  if (argc == 3) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_IntVectorVector_insert__SWIG_0(self, argc, argv);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_IntVectorVector_insert__SWIG_1(self, argc, argv);
          }
        }
      }
    }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'IntVectorVector_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_IntVectorVector_reserve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "IntVectorVector_reserve", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_int_std__allocatorT_int_t_t_std__allocatorT_std__vectorT_int_std__allocatorT_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *IntVectorVector_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject *_wrap_norm_square(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int arg2 ;
  int val1 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "norm_square", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "norm_square" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "norm_square" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = norm_square(arg1,arg2);
  resultobj = swig::from(static_cast< std::vector< int,std::allocator< int > > >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_teste_lista_aninhada(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "teste_lista_aninhada" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = teste_lista_aninhada(arg1);
...
SWIGINTERN PyObject *_wrap_vector_n(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int arg2 ;
  int val1 ;
  ...
  int ecode2 = 0 ;
  PyObject *swig_obj[2] ;
  std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > result;
  
  if (!SWIG_Python_UnpackTuple(args, "vector_n", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "vector_n" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "vector_n" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = vector_n(arg1,arg2);
  resultobj = swig::from(static_cast< std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > >(result));
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_vectorToNestedList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = swig::asptr(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "vectorToNestedList" "', argument " "1"" of type '" "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "vectorToNestedList" "', argument " "1"" of type '" "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (PyObject *)vectorToNestedList((std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > const &)*arg1);
  resultobj = result;
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "DoubleMap_iterator", _wrap_DoubleMap_iterator, METH_O, NULL},
	 { "DoubleMap___nonzero__", _wrap_DoubleMap___nonzero__, METH_O, NULL},
	 { "DoubleMap___bool__", _wrap_DoubleMap___bool__, METH_O, NULL},
	 { "DoubleMap___len__", _wrap_DoubleMap___len__, METH_O, NULL},
	 { "DoubleMap___getitem__", _wrap_DoubleMap___getitem__, METH_VARARGS, NULL},
	 { "DoubleMap___delitem__", _wrap_DoubleMap___delitem__, METH_VARARGS, NULL},
	 { "DoubleMap_has_key", _wrap_DoubleMap_has_key, METH_VARARGS, NULL},
	 { "DoubleMap_keys", _wrap_DoubleMap_keys, METH_O, NULL},
	 { "DoubleMap_values", _wrap_DoubleMap_values, METH_O, NULL},
	 { "DoubleMap_items", _wrap_DoubleMap_items, METH_O, NULL},
	 { "DoubleMap___contains__", _wrap_DoubleMap___contains__, METH_VARARGS, NULL},
	 { "DoubleMap_key_iterator", _wrap_DoubleMap_key_iterator, METH_O, NULL},
	 { "DoubleMap_value_iterator", _wrap_DoubleMap_value_iterator, METH_O, NULL},
	 { "DoubleMap___setitem__", _wrap_DoubleMap___setitem__, METH_VARARGS, NULL},
	 { "DoubleMap_asdict", _wrap_DoubleMap_asdict, METH_O, NULL},
	 { "new_DoubleMap", _wrap_new_DoubleMap, METH_VARARGS, NULL},
	 { "DoubleMap_empty", _wrap_DoubleMap_empty, METH_O, NULL},
	 { "DoubleMap_size", _wrap_DoubleMap_size, METH_O, NULL},
	 { "DoubleMap_swap", _wrap_DoubleMap_swap, METH_VARARGS, NULL},
	 { "DoubleMap_begin", _wrap_DoubleMap_begin, METH_O, NULL},
	 { "DoubleMap_end", _wrap_DoubleMap_end, METH_O, NULL},
	 { "DoubleMap_rbegin", _wrap_DoubleMap_rbegin, METH_O, NULL},
	 { "DoubleMap_rend", _wrap_DoubleMap_rend, METH_O, NULL},
	 { "DoubleMap_clear", _wrap_DoubleMap_clear, METH_O, NULL},
	 { "DoubleMap_get_allocator", _wrap_DoubleMap_get_allocator, METH_O, NULL},
	 { "DoubleMap_count", _wrap_DoubleMap_count, METH_VARARGS, NULL},
	 { "DoubleMap_erase", _wrap_DoubleMap_erase, METH_VARARGS, NULL},
	 { "DoubleMap_find", _wrap_DoubleMap_find, METH_VARARGS, NULL},
	 { "DoubleMap_lower_bound", _wrap_DoubleMap_lower_bound, METH_VARARGS, NULL},
	 { "DoubleMap_upper_bound", _wrap_DoubleMap_upper_bound, METH_VARARGS, NULL},
	 { "delete_DoubleMap", _wrap_delete_DoubleMap, METH_O, NULL},
	 { "DoubleMap_swigregister", DoubleMap_swigregister, METH_O, NULL},
	 { "DoubleMap_swiginit", DoubleMap_swiginit, METH_VARARGS, NULL},
	 { "IntVectorVector_iterator", _wrap_IntVectorVector_iterator, METH_O, NULL},
	 { "IntVectorVector___nonzero__", _wrap_IntVectorVector___nonzero__, METH_O, NULL},
	 { "IntVectorVector___bool__", _wrap_IntVectorVector___bool__, METH_O, NULL},
	 { "IntVectorVector___len__", _wrap_IntVectorVector___len__, METH_O, NULL},
	 { "IntVectorVector___getslice__", _wrap_IntVectorVector___getslice__, METH_VARARGS, NULL},
	 { "IntVectorVector___setslice__", _wrap_IntVectorVector___setslice__, METH_VARARGS, NULL},
	 { "IntVectorVector___delslice__", _wrap_IntVectorVector___delslice__, METH_VARARGS, NULL},
	 { "IntVectorVector___delitem__", _wrap_IntVectorVector___delitem__, METH_VARARGS, NULL},
	 { "IntVectorVector___getitem__", _wrap_IntVectorVector___getitem__, METH_VARARGS, NULL},
	 { "IntVectorVector___setitem__", _wrap_IntVectorVector___setitem__, METH_VARARGS, NULL},
	 { "IntVectorVector_pop", _wrap_IntVectorVector_pop, METH_O, NULL},
	 { "IntVectorVector_append", _wrap_IntVectorVector_append, METH_VARARGS, NULL},
	 { "IntVectorVector_empty", _wrap_IntVectorVector_empty, METH_O, NULL},
	 { "IntVectorVector_size", _wrap_IntVectorVector_size, METH_O, NULL},
	 { "IntVectorVector_swap", _wrap_IntVectorVector_swap, METH_VARARGS, NULL},
	 { "IntVectorVector_begin", _wrap_IntVectorVector_begin, METH_O, NULL},
	 { "IntVectorVector_end", _wrap_IntVectorVector_end, METH_O, NULL},
	 { "IntVectorVector_rbegin", _wrap_IntVectorVector_rbegin, METH_O, NULL},
	 { "IntVectorVector_rend", _wrap_IntVectorVector_rend, METH_O, NULL},
	 { "IntVectorVector_clear", _wrap_IntVectorVector_clear, METH_O, NULL},
	 { "IntVectorVector_get_allocator", _wrap_IntVectorVector_get_allocator, METH_O, NULL},
	 { "IntVectorVector_pop_back", _wrap_IntVectorVector_pop_back, METH_O, NULL},
	 { "IntVectorVector_erase", _wrap_IntVectorVector_erase, METH_VARARGS, NULL},
	 { "new_IntVectorVector", _wrap_new_IntVectorVector, METH_VARARGS, NULL},
	 { "IntVectorVector_push_back", _wrap_IntVectorVector_push_back, METH_VARARGS, NULL},
	 { "IntVectorVector_front", _wrap_IntVectorVector_front, METH_O, NULL},
	 { "IntVectorVector_back", _wrap_IntVectorVector_back, METH_O, NULL},
	 { "IntVectorVector_assign", _wrap_IntVectorVector_assign, METH_VARARGS, NULL},
	 { "IntVectorVector_resize", _wrap_IntVectorVector_resize, METH_VARARGS, NULL},
	 { "IntVectorVector_insert", _wrap_IntVectorVector_insert, METH_VARARGS, NULL},
	 { "IntVectorVector_reserve", _wrap_IntVectorVector_reserve, METH_VARARGS, NULL},
	 { "IntVectorVector_capacity", _wrap_IntVectorVector_capacity, METH_O, NULL},
	 { "delete_IntVectorVector", _wrap_delete_IntVectorVector, METH_O, NULL},
	 { "IntVectorVector_swigregister", IntVectorVector_swigregister, METH_O, NULL},
	 { "IntVectorVector_swiginit", IntVectorVector_swiginit, METH_VARARGS, NULL},
	 { "norm_square", _wrap_norm_square, METH_VARARGS, NULL},
	 { "teste_lista_aninhada", _wrap_teste_lista_aninhada, METH_O, NULL},
	 { "vector_n", _wrap_vector_n, METH_VARARGS, NULL},
	 { "vectorToNestedList", _wrap_vectorToNestedList, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t = {"_p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t", "std::map< double,std::vector< std::vector< double > > >::allocator_type *|std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__lessT_double_t = {"_p_std__lessT_double_t", "std::less< double > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t = {"_p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t", "std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::less< double >,std::allocator< std::pair< double const,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > > *|std::map< double,std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > *|std::map< double,std::vector< std::vector< double > > > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t,
  ...
  &_swigt__p_std__lessT_double_t,
  &_swigt__p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t,
...
static swig_cast_info _swigc__p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t[] = {  {&_swigt__p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t[] = {  {&_swigt__p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t,
  ...
  _swigc__p_std__lessT_double_t,
  _swigc__p_std__mapT_double_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_std__lessT_double_t_std__allocatorT_std__pairT_double_const_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t_t_t_t,
